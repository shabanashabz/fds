!(function (t) {
    ...
    (n.instance = function instance() {
      ...
      (n.prototype.createAnimation = function t(e) {
        for (var i = 0; i < this.animations.length; i++)
          if (this.animations[i].isMatch(e && e.name))
  ...
  314: function (t, e, i) {
    "use strict";
    var n = i(133).instance();
    n.registerAnimation(i(315)), n.registerAnimation(i(318));
  },
  315: function (t, e, i) {
    "use strict";
    function n(t, e) {
        ...
        if (
          ...
          var e = '"{files}" file(s) size exceeds maximum limit.',
            files = t
              ...
              .join(", ");
          FormMessage.showError(form, e.replace(/\{files\}/, files));
        }
    }
    function f(form) {
...
*/
  ...
  8416: function (t, e, i) {
    "use strict";
    var Animation = i(8417),
      n = i(133);
    i(314), (window.uAnimation = new Animation(n.instance()).init());
  },
  8417: function (t, e, i) {
    "use strict";
  ...
  8439: function (t, e, i) {
    ...
    }.call(e, i(71), i(182).setImmediate, i(26), i(115).Buffer));
  },
  8440: function (t, e, i) {
    "use strict";
    (function (e) {
