...
if (isset($_POST['btn'])) {
    ...
    if ($veg_quantity <= $details["veg_quantity"] && $non_veg_quantity <= $details["non_veg_quantity"]) {
        if($veg_quantity>0 && $non_veg_quantity>0){
        ...
        // $mes = "Sorry your oder is beyond limit..........!!!!!!!";
    }
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./static/css/nav3.css">
    ...
    <body>
        ...
        <div class="centered">
    <div class="img">
      <img src="https://i.imgur.com/hFQpZ7l.png">
      <h1 style="font-size:larger;">Make Your Order </h1>
      <h1 style="font-size:larger;">Now</h1><br><br>
      <p style="padding-left: 200px;" class="slogan">“The fruit of love is service, which is compassion in action”</p>
    </div>
    <form class="ajax" id="ajax-form" action="bk.php?event_id=<?php echo $event_id ?>" method="POST" enctype="multipart/form-data">
    <div class="form">
      <div class="input-fields">

        <input type="hidden"<?php echo $details1 != null ? $details1['name'] : ''; ?>>
        <input type="hidden"<?php echo $details1 != null ? $details1['email_id'] : ''; ?>>
        <input type="hidden"<?php echo $details != null ? $details['name'] : ''; ?>>
        <input type="hidden"<?php echo $details != null ? $details['email_id'] : ''; ?>>

        <label> VEG Quantity</label>
        <input type="number" placeholder="Enter quantity" name="veg_quantity" min="0" required><br><br>

        <label>Non Veg Quantity</label>
        <input type="number" placeholder="Enter quantity" name="non_veg_quantity" min="0" required> <br><br>

       </div>
       <div class="buttons">
        <button type="submit" name="btn" onclick="myFunction()">DONE</button><br><br><br>
       </div>
  ...
  <script>
         function myFunction(){
            ...
            alert("If your order is success then you will be directed to mail page then send the mail for confirmation");
