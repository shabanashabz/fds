    ...
    <nav>
        <div class="navbar">
                <div class="menu-items">
                    <a href="eventhome.php"><i class="fa-solid fa-house"></i>  Home</a>
                    <a href="eventmanagement.php"><i class="fa-solid fa-user"></i>  Profile</a>
...
<div class="container">
    ...
    <div class="about">
        <div class="left">
            ...
            <p>
                    ...
                    Food donation System is an organisation which aims to redistribute excess food from weddings, parties, events to those who are hungry.
                    Food Donation System works alongside Governments, Corporates with Social Responsibility on their minds, other partners and Volunteers to create a local chapter of excess food collection institution, which will be spread across various cities, addressing the two major challenges – namely urban and environmental, following the United Nations Sustainable Development Goals.
        ...
        <div class="right">
            <img src="https://images.theconversation.com/files/74007/original/image-20150306-3284-1jam94v.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=926&fit=clip">
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="mission">
        ...
        <div class="left">
            <img src="https://www.treehugger.com/thmb/Fn4Q_si9vO1Kti_7YxFk90K045k=/768x0/filters:no_upscale():max_bytes(150000):strip_icc()/manlooksforfoodindumpster-ed0b8455d0cd49e7b54183d8f89d1ed3.jpg">
        </div>
        <div class="right">
            <h1>Mission</h1>
            <hr>
